...
args: ["css"],
source: "paintOn: css\x0a\x22using the CSSCanvas, select attributes from the subtree and paint them\x22",
messageSends: [],
referencedClasses: []
}),
smalltalk.Component);
...
args: [],
source: "realize\x0a\x0a|html css selector jq|\x0a\x0a jq := ('#',(parent pid),connectorId) asJQuery.\x0a (jq children length = 0)\x0a ifTrue:[\x0a   \x09selector := '#',(parent pid),connectorId,'0'.\x0a \x09jq := selector asJQuery.\x0a\x09jq append: '<div id = ', pid ,'></div>'. ]\x0a  ifFalse:[\x0aselector := '#',(parent pid),connectorId,'0 ',':nth-child(',position asString,')'.\x0ajq := selector asJQuery.\x0ajq after: '<div id = ', pid ,'></div>'.\x0a].\x0ahtml := HTMLCanvas onJQuery: ('#',pid) asJQuery.\x0aself renderOn: html.\x0acss := CSSCanvas new: self.\x0aself paintOn:css\x0a\x0a",
...
args: ["html"],
source: "renderOn: html\x0a\x0a\x22Use the html canvas to render a component\x22",
messageSends: [],
referencedClasses: []
}),
smalltalk.Component);
...
args: ["anUrl"],
source: "root: anUrl\x0a\x0aurl:= anUrl.\x0a\x0apid:=''.\x0aconnectors:=Connectors new.\x0aconnectors addConnectorId: ''.\x0a'body' asJQuery append:'<div id = 0> </div>'.\x0a(connectors at:'') at:0 put: ('#0' asJQuery get:0).",
...
args: [],
source: "setConnectors\x0a\x0a\x22Used to initialize the connectors\x22",
messageSends: [],
referencedClasses: []
}),
smalltalk.Component);
...
args: [],
source: "setEquations\x0a\x0a\x22Used to initialize the Equations\x22",
messageSends: [],
referencedClasses: []
}),
smalltalk.Component);
...
args: [],
source: "setVariables\x0a\x0a\x22Used to initializing the binding Variables\x22",
messageSends: [],
referencedClasses: []
}),
smalltalk.Component);
...
args: ["anUrl"],
source: "root: anUrl\x0a\x0a ^ self new root:anUrl ; yourself.\x0a ",
